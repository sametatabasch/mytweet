		...
		<tr>
			...
			<table border="1" width="450" cellspacing="0" cellpadding="5" style="border-collapse: collapse;" bgcolor="#FFFFFF">
				...
				<tr>
					...
					<?php $value = ( $_POST['From_Email'] != '' ) ? $_POST['From_Email'] : ''; ?>
					<td class="colrite"><input type="text" name="From_Email" value="<?php echo $value; ?>" style="width:99%;">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<?php $value = ( $_POST['Message'] != '' ) ? $_POST['Message'] : ''; ?>
					<td class="colrite"><textarea name="Message" style="width:99%;height:50px;"><?php echo $value; ?></textarea>
					</td>
				</tr>
			</table>
			</td>
			<td valign="top"><strong>Mail Test Specs</strong><br /><br />
					...
					<tr>
						...
						<td class="colrite">
							<table>
								<tr>
									<td>
										<input type="radio" name="test_type" value="mail" <?php echo ( $_POST['test_type'] == 'mail' ) ? 'checked' : ''; ?>>
									</td>
									<td>Mail()</td>
								</tr>
								<tr>
									<td>
										<input type="radio" name="test_type" value="sendmail" <?php echo ( $_POST['test_type'] == 'sendmail' ) ? 'checked' : ''; ?>>
									</td>
									<td>Sendmail</td>
								</tr>
								<tr>
									<td>
										<input type="radio" name="test_type" value="qmail" <?php echo ( $_POST['test_type'] == 'qmail' ) ? 'checked' : ''; ?>>
									</td>
									<td>Qmail</td>
								</tr>
								<tr>
									<td>
										<input type="radio" name="test_type" value="smtp" <?php echo ( $_POST['test_type'] == 'smtp' ) ? 'checked' : ''; ?>>
									</td>
									<td>SMTP</td>
								</tr>
							</table>
				...
				<table border="1" width="450" cellspacing="0" cellpadding="5" style="border-collapse: collapse;" bgcolor="#FFFFFF">
					...
					<tr>
						...
						<?php $value = ( $_POST['smtp_server'] != '' ) ? $_POST['smtp_server'] : $CFG['smtp_server']; ?>
						<td class="colrite"><input type="text" name="smtp_server" value="<?php echo $value; ?>" style="width:99%;">
						</td>
					</tr>
					<tr>
						<td class="colleft">SMTP Port</td>
						<?php $value = ( $_POST['smtp_port'] != '' ) ? $_POST['smtp_port'] : $CFG['smtp_port']; ?>
						<td class="colrite"><input type="text" name="smtp_port" value="<?php echo $value; ?>" style="width:99%;">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<?php $value = ( $_POST['authenticate_username'] != '' ) ? $_POST['authenticate_username'] : $CFG['smtp_username']; ?>
						<td class="colrite">
							<input type="text" name="authenticate_username" value="<?php echo $value; ?>" style="width:99%;"></td>
					</tr>
					<tr>
						<td class="colleft">Authenticate Password</td>
						<?php $value = ( $_POST['authenticate_password'] != '' ) ? $_POST['authenticate_password'] : $CFG['smtp_password']; ?>
						<td class="colrite">
							<input type="password" name="authenticate_password" value="<?php echo $value; ?>" style="width:99%;"></td>
					</tr>
				</table>
			</td>
		</tr>
